export default function FullWithPlan() {
  const steps = [
  ...
  return (
    <div className="min-h-screen p-6 bg-white text-gray-800">
      <h1 className="text-2xl font-bold mb-4">New Client Workflow – Full Planning (With Existing Plan)</h1>
      <p className="mb-6">This workflow outlines the onboarding process for new clients who already have an existing financial plan.</p>
